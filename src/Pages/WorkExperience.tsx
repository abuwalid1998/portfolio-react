...
const WorkExperience = () => {
    return (
        <div className="container mx-auto p-6 bg-gray-50">
            <h2 className="text-3xl font-bold text-center mb-12 animate-fade-in-down">Work Experience</h2>
            <div className="relative border-l-4 border-amber-500">
                {experiences.map((experience, index) => (
                    <div
                        key={index}
                        className={`mb-8 flex justify-between items-center w-full ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'} animate-slide-in`}
                    >
